...
@section('content')
    ...
    <div class="card-header">
        <h3 class="card-title"><span style="color:rgb(6, 6, 6);font-weight:bold">Data Produk</h3>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createModalLabel">Edit Produk</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
             <form id="editBarang" method="post">
              @csrf
                        ...
                        <div class="form-group">
                            <label for="nama_barang_edit">Nama Produk</label>
                            <input type="text" name="nama_barang_edit" class="form-control" id="nama_barang_edit" placeholder="Nama barang">
                        </div>
                        <div class="form-group">
                            <label for="keterangan_edit">keterangan</label>
                            <input type="text" name="keterangan_edit" class="form-control" id="keterangan_edit" placeholder="Keterangan">
                        </div>
                        <div class="form-group">
                            <label for="harga_jual_edit">Harga Jual</label>
                            <input type="number" name="harga_jual_edit" class="form-control" id="harga_jual_edit">
                        </div>
                        <div class="modal-footer justify-content-between">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                          <button type="submit" name="submit" class="btn btn-primary">Simpan</button>
